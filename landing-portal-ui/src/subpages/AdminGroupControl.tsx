            ...
            <Grid container xs={12} rowGap={1}>
              ...
              <Grid item xs={12}>
                <GroupActionsPanel
                  ...
                  onGroupMetadataChange={props.onMetadataChange}
                  onUserListChange={() => {
    ...
    <Table padding={"checkbox"} className={classes.PropertyTable}>
      <TableBody>
        <TableRow className={classes.PropertyTableRow}>
          ...
          <TableCell className={classes.PropertyTableCell} align={"right"}>
            {
              //value
            }
        ...
        <div style={{ height: tableHeight, width: "100%" }}>
          <DataGrid
            ...
            onSelectionModelChange={(newSelectionModel) => {
              ...
              props.setSelectedMembers(newSelectionModel as Array<string>);
            }}
...
const GroupActionsPanel = observer((props: GroupActionsPanelProps) => {
    ...
    <React.Fragment>
      {removingMembers && (
        <RemoveMembersDialog
          ...
          onConfirm={() => {
            localGroupStore
              .removeMembers(props.selectedMembers, props.populatedGroup.id)
  ...
  return (
    ...
    >
        ...
        >
          <Grid item xs={12}>
            <Typography variant="subtitle1" align={"center"}>
              Manage group members - to remove members, make a selection on the
              left
            </Typography>
          </Grid>
          <Grid item>
      ...
      <Grid item xs={12}>
        <Grid container xs={12} rowGap={2} justifyContent={"space-evenly"}>
          <Grid item xs={12}>
            <Typography variant="subtitle1" align={"center"}>
...
export const GroupControl = observer((props: GroupControlProps) => {
  ...
  if (groupStore.listGroupsAction.failed()) {
    body = (
      <Grid container xs={12}>
        An error occurred while loading the groups list. Are you sure you have
        access? Try refreshing. Error info:{" "}
  ...
  // If groups are loading then return loading symbol
    ...
    body = groupList ? (
            ...
            <Grid item>
              ...
              <Grid item xs={12}>
                <Typography variant="body1">
                  You can see a list of groups below. Click to expand each group
      ...
      <React.Fragment>
        An error occurred loading the group list, try refreshing or contact an
        admin.
      </React.Fragment>
    );
  }
