...
const UserLinkCheckDisplayComponent = (
  ...
  const content: JSX.Element = (
    <Stack direction="column" spacing={2}>
      ...
      <p>
        <a href={toolLink}>Click here</a> to link yourself to a Person in the
        Registry. For more help, visit our <a href={docLink}>documentation</a>.
      </p>
    </Stack>
  );
...
const Introduction = observer(() => {
  ...
  const newUserDialog = (
    ...
    >
      ...
      <DialogContent>
        We have detected that you have no roles attached to your account. You
        can use the profile icon button in the top right of the screen to visit
        your profile. Then click the Roles tab to view and request additional
        roles. For more information about how to request access permissions for
          ...
          <Grid container xs={12}>
            ...
            <Grid xs={6}>
              <div className={classes.description}>
                <img src="/provena_components.png" width="100%" />
              </div>
            </Grid>
          </Grid>
