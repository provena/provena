...
pipeline_link_q_string=$(echo "{\"f\":{\"text\":\"f${ticket_no}\"},\"s\":{\"property\":\"updated\",\"direction\":-1},\"n\":10,\"i\":0}" | base64 -w 0)
...
echo "To tear down feature deployment: ./fb destroy${ui_only_arg}${ticket_no} ${feat_desc}"
