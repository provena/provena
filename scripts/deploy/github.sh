#!/bin/bash
# Script for deploying GitHub bootstrap stack
...
usage() {
    ...
    echo
    echo "Arguments:"
    echo "  namespace/stage/config     The namespace/stage/config for the GitHub bootstrap stack"
    echo
    echo "Options:"
...
# GitHub bootstrap stack deployment
...
print_message "Running cdk deploy for GitHub bootstrap stack"
cdk deploy
