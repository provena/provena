...
import { EntityBase } from "../provena-interfaces/RegistryModels";
    ...
    <Grid container item className={classes.resultCardContainer}>
      ...
      >
        <Card variant="outlined" className={classes.resultCard}>
          <Grid container item xs={1} className={classes.cardColourBar}></Grid>
            ...
            >
              ...
              >
                <Typography className={classes.cardHeader}>
                  {mapSubTypeToPrettyName(props.cardDetails.item_subtype)}
                  {props.isUser && " (You)"}
                </Typography>
                <Grid
                ...
                >
                  ...
                  {!!props.cardDetails.versioning_info?.version &&
                    subtypeHasVersioning(props.cardDetails.item_subtype) &&
                ...
                <Grid className={classes.cardDetailText}>
                  ...
                  {timestampToLocalTime(props.cardDetails.created_timestamp)}
                </Grid>
                <Grid
                  container
                  item
