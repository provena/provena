...
export const PersonEthicsTickConsent = (
  ...
  const LHContent = (
    <p>
      Have you received consent and been granted permission from the person to
  ...
  const RHContent = (
    <p>
      ...
      <ol>
        ...
        <li>
          The person being included and referenced in provenance and dataset
          records in the information system
        </li>
        <li>
          Enabling users of the information system to query the system using the
          person identifier, e.g. related provenance and/or data records
        </li>
      </ol>
    </p>
  );
