    ...
    <Tooltip
        title={
            <React.Fragment>
                ...
                This resource is locked and cannot be modified. To learn more
                about resource locks, see{" "}
...
const RecordView = observer((props: {}) => {
    ...
    const loadingItem = typedLoading || untypedLoading || authState.loading;
    ...
    const fetchErrorContent: JSX.Element = (
        <p>
            ...
            {contains401 && (
                <p>
                    If you would like more information about accessing items in
                    the registry see{" "}
                    <a
                        href={registryAccessLink}
                        target="_blank"
                        rel="noreferrer"
                    >
                        our documentation
    ...
    const historyErrorContent: JSX.Element = (
        <p>
            An error occurred while determining the history of the registry
            item. Please contact an administrator. Error:{" "}
            {historyErrorMessage ?? "Unknown"}.
        </p>
    );
