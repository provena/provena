  ...
  return (
    <Grid2 container className={classes.filterPanel} spacing={1}>
      ...
      <Grid2 xs={3}>
        <FormControl fullWidth>
          <ItemSubtypeSelector
            disabled={!props.filterSubtype || !!props.selectSubtypeDisabled}
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                onChange={() => {
                  props.setFilterSubtype(!props.filterSubtype);
                }}
        ...
        >
          ...
          <FormControl>
            <TextField
              ...
              onChange={(event) => {
                event.preventDefault();
                setTextfieldInputHandleId(event.target.value as string);
              }}
              value={textfieldInputHandleId}
              error={untypedLoadedItem.error && textfieldInputHandleId !== ""}
              InputProps={{
  ...
  const errorContent = insufficientAccess ? (
    ...
    <Grid container item xs={12} className={classes.gridContainer}>
      ...
      >
        ...
        >
          You do not have sufficient registry store permissions to view registry
          entities.
        </Alert>
