      ...
      <BoundedContainer breakpointKey={"lg"}>
        <Grid container rowGap={2} className={classes.topPanel}>
          <Grid item xs={9}>
            <Typography variant="h5" textAlign="center">
              Explore and register entities to support modelling and data
              provenance.
            </Typography>
          </Grid>
          <Grid item xs={3} pl={2}>
            ...
            <Typography variant="body1">
              <a
                target="doc"
                href={DOCUMENTATION_BASE_URL + "/registry/overview.html"}
              >
        ...
        <Grid container xs={12} className={classes.actionContainer}>
          <Grid container item xs={6}>
            <Grid container item sx={{ mr: 2 }} className={classes.optionPanel}>
              <Typography
                gutterBottom
                variant="h5"
                sx={{ mt: 2 }}
          ...
          <Grid container item xs={6}>
            <Grid container item sx={{ ml: 2 }} className={classes.optionPanel}>
              <Typography
                gutterBottom
                variant="h5"
                sx={{ mt: 2 }}
