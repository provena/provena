...
import { UserGroupMetadata } from "../../provena-interfaces/AuthAPI";
import {
  AccessSettings,
  DescribedRole,
  ItemSubType,
    ...
    <Table>
      ...
      <TableBody>
        {props.availableRoles.map((describedRole: DescribedRole) => {
          const granted = props.roles.indexOf(describedRole.role_name) !== -1;
          return (
                ...
                <Switch
                  ...
                  onChange={() => {
                    if (granted) {
                      ...
                      const newList: string[] = JSON.parse(
                        JSON.stringify(props.roles),
                      );

                      // remove the role name
                      newList.splice(
                        newList.indexOf(describedRole.role_name),
                        1,
                      );
                      ...
                      // push the role name
                      newList.push(describedRole.role_name);
    ...
    <div style={{ width: "100%" }}>
      <Stack direction="column" spacing={2}>
        ...
        <Typography variant={"subtitle1"}>
          Select which roles are granted to all users of the Registry for this
      ...
      <div style={{ height: 400, width: "100%" }}>
        ...
        <DataGrid
          ...
          onSelectionModelChange={(newSelectionModel) => {
            ...
            props.submitSelection(newSelectionModel as Array<string>);
          }}
    ...
    */
    ...
    return (
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            You can use the sliders below to choose which roles are granted to
            users within this group for the current resource.
          </DialogContentText>
          <RolesSelector
            availableRoles={props.availableRoles}
            roles={updatedRoles}
...
const GroupAccess = observer((props: GroupAccessProps) => {
  ...
  const [editingGroupDialog, setEditingGroupDialog] = useState<boolean>(false);
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      <Stack direction="column" spacing={2}>
        ...
        <Typography variant={"subtitle1"}>
          Use the table below to specify roles for this resource on a per-group
          basis.
        </Typography>
        <Table>
          <TableHead>
          ...
          <TableBody>
            {selectedGroups.map((groupId: string) => {
              ...
              const metadata: UserGroupMetadata | undefined =
                props.groupMetadata.find((metadata: UserGroupMetadata) => {
              ...
              return (
                <TableRow key={groupId}>
                  ...
                  <TableCell>{metadata?.display_name ?? "Error"}</TableCell>
                  {
                    // Group description
                  }
                  <TableCell>{metadata?.description ?? "Error"}</TableCell>
                  {
                    // Granted roles
                  }
                  <TableCell>
                    {roles.length === 0 ? "None" : rolesPrettyPrint(roles)}
                  </TableCell>
                  {
                    // Edit button
                  }
      ...
      return (
        <div style={{ width: "100%" }}>
          <SuccessPopup
            ...
            message={"Access settings were successfully updated! Refreshing..."}
            open={successPopup}
          />
        </div>
      );
          ...
          >
            ...
            >
              <Typography variant="body1" align="center">
                An error occurred while submitting your updated access
                permissions. The error was: {error ?? "Unknown"}. Try refreshing
                the page or run the update again. Hit dismiss below to hide this
                message.
              </Typography>
            </Grid>
            <Grid>
    ...
    return (
      ...
      >
        ...
        >
          <Stack direction="column" spacing={2}>
            <Typography variant="h5" align="center">
              Submit your access changes by pressing the button below, or revert
              your changes.
            </Typography>
            {props.itemSubtype === "DATASET" && (
              <Typography variant="subtitle1" align="left">
                Before submitting this access change, please determine if there
                are any ethics, privacy or Indigenous knowledge considerations
                for this dataset. Ensure only appropriate users will be granted
                access.
              </Typography>
            )}
          </Stack>
        ...
        <Grid container xs={12} spacing={2} justifyContent={"center"}>
          <Grid item>
            <Button variant="contained" color="warning" onClick={props.onClear}>
              Revert changes
            </Button>
          </Grid>
          <Grid item>
...
export const AccessControl = observer((props: AccessControlProps) => {
  ...
  const headerContent = (
    ...
    >
      ...
      <Grid item xs={12}>
        Provides controls over who can see or edit the metadata and data of your
        resource. {expanded ? "" : "Expand to see more."}
      </Grid>
    </Grid>
  );
        ...
        <div style={{ minWidth: "100%", width: "100%" }}>
          ...
          <Stack spacing={3} style={{ width: "100%" }}>
            <h3>
              ...
              {getAuthConfigData!.owner === username ? " (You)" : ""}
            </h3>
