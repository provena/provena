...
import { Credentials, ReleasedStatus } from "provena-interfaces/DataStoreAPI";
...
const DatasetApprovalsComponent = (props: DatasetApprovalsComponentProps) => {
  ...
  return (
    <div>
      ...
      Relevant: <i>{approvals.ethics_registration.relevant ? "Yes" : "No"}</i>
      <br />
      Obtained: <i>{approvals.ethics_registration.obtained ? "Yes" : "No"}</i>
    ...
    <React.Fragment>
      <Grid container>
        ...
        <Grid item xs={6} className={classes.overviewGrid}>
          <OrganisationDetailsDisplayComponent
            organisationId={
              props.dataset.collection_format.associations.organisation_id
            }
        ...
        <Grid item xs={6} className={classes.overviewGrid}>
          <OrganisationDetailsDisplayComponent
            organisationId={
              props.dataset.collection_format.dataset_info.publisher_id
            }
        ...
        <Grid item xs={6} className={classes.overviewGrid}>
          <h3>URL</h3>
          <a href={collectionFormat.dataset_info.license} target="_blank">
    ...
    return (
      <div>
        <Grid container>
          ...
          >
            <Grid item>
              An error occurred when retrieving your credentials. Error message:{" "}
              {props.errorMessage}. You can try requesting credentials again by
              clicking the request button.
            </Grid>
            <Grid item xs="auto">
              <Button onClick={props.requestNewCreds} variant="contained">
                Request credentials
              </Button>
            </Grid>
          </Grid>
      ...
      <div>
        <Grid container>
          ...
          >
            ...
            <Grid item xs="auto">
              <Button variant="contained" onClick={props.requestNewCreds}>
                Refresh credentials
              </Button>
            </Grid>
          </Grid>
  ...
  return (
    ...
    >
      ...
      <p style={{ textAlign: "center" }}>
        This dataset has been locked. You cannot modify this dataset unless it
        is unlocked. Click{" "}
...
const DownloadGuidance = observer((props: DownloadGuidanceProps) => {
  ...
  const isExternal = !(
    props.dataset.collection_format.dataset_info.access_info.reposited ?? true
  );
      ...
      {isExternal && (
        <div style={{ marginBottom: "20px" }}>
          <Alert variant="outlined" severity="warning">
            ...
            This dataset has been marked as having files stored externally. You
            may still use the provided storage to host attachments or other data
            associated with the primary dataset files.
          </Alert>
        </div>
      )}
      <div>
        You can download files from this dataset using the methods below. For
      ...
      {creds ? (
        <React.Fragment>
          <Grid container rowGap={2}>
            <Grid item xs={12}>
              <h3>Previewing and downloading files individually</h3>
            </Grid>
            <Grid item xs={12}>
              <div style={{ width: "100%", marginBottom: "10px" }}>
                Using the previewer below, you can navigate the files in this
                dataset, generate{" "}
                <a
            ...
            <Grid item xs={12}>
              <Grid container justifyContent="space-between">
                <Grid item xs={7.5}>
                  <div>
                    The below method allows you to explore the dataset with a
                    GUI and download files individually:
                  </div>
                  <ol>
                    <li>
                      Open{" "}
                      ...
                      or the button on the right to login to the AWS system. You
                      will be brought to your storage location automatically.
                    </li>
                    <li>
                      You can now explore the dataset and use the orange
                      'Download' action after ticking an item.
                    </li>
                  </ol>
                </Grid>
                <Grid item xs={3.5}>
                  ...
                  >
                    ...
                    <Button
                      ...
                      variant="contained"
                      onClick={() => {
                        window.open(downloadingGuidanceLink, "_blank");
                      }}
                    >
                      Click to learn more
                    </Button>
          ...
          <div>
            ...
            The steps below will give guidance on this process.
          </div>
          <div>
            Please note that you need to have the AWS CLI v2 installed to follow
            the below steps. For more information on how to prepare your system
            for CLI upload (and download), visit{" "}
          ...
          <ol>
            <li>
              Shown below are your temporary <b>read-only</b> AWS programmatic
              access credentials:
              <AWSCredentialDisplay credentials={creds}></AWSCredentialDisplay>
            </li>
            <li>
              Copy and paste the credentials into your AWS CLI terminal
              environment. You can change the format of the environment variable
              export statements using the buttons above the generated
              credentials.
            </li>
            <li>
              Using your terminal, navigate to where you want the data to be
              downloaded to. You should create a new folder to put the dataset
              files into. Use the below command to copy all files from the
              dataset into your folder, replacing 'folder' with the name of your
              folder:
              <div className={classes.code}>
                <CopyFloatingButton
                  clipboardText={`aws s3 cp ${props.dataset.s3.s3_uri} folder --recursive`}
                />
                aws s3 cp {props.dataset.s3.s3_uri} folder --recursive
              </div>
            </li>
            <li>
              You can use other AWS CLI commands to explore the directory,
              including the list command:
              <div className={classes.code}>
                <CopyFloatingButton
              ...
              Or by using the AWS console to preview your bucket location's
              contents (see links in above method).
            </li>
          </ol>
        </React.Fragment>
      ) : null}
...
const ExternalAccess = observer((props: ExternalAccessProps) => {
  ...
  return (
    <div>
      ...
      <p>
        This dataset references files which are hosted externally. The dataset
        files are not available for download through the Data Store. You may be
        able to access the dataset files based on the information provided
      ...
      <div>
        ...
        {isWebUrl ? (
          <a href={accessInfo.uri ?? ""} target="_blank" rel="noreferrer">
      ...
      <div>
        ...
        {isExternal && (
          <div style={{ marginBottom: "20px" }}>
            <Alert variant="outlined" severity="warning">
              <AlertTitle>Externally Reposited Data</AlertTitle>
              This dataset has been marked as having files stored externally.
              You may still use the provided storage to host attachments or
              other data associated with the primary dataset files.
            </Alert>
          </div>
        )}
        <div>
          Your dataset was minted successfully, you can now upload the dataset
          files. For more information about this process, visit this{" "}
        ...
        <CredentialRequest
          ...
          loading={datasetDetailStore.requestingAwsCreds}
          errorMessage={datasetDetailStore.requestingAWSCredsMessage}
          requestNewCreds={() => datasetDetailStore.generateCreds(true)}
        ></CredentialRequest>
        {creds ? (
          <React.Fragment>
            ...
            <Grid container justifyContent="space-between">
              <Grid item xs={7.5}>
                <div>
                  ...
                  5GB) and you would like to use a GUI to upload your data,
                ...
                <ol>
                  <li>
                    ...
                    or use the button on the right to login to the AWS system.
                    You will be brought to your designated storage location.{" "}
                  </li>
                  <li>
                    You can upload the data using the AWS console - click the
                    orange "Upload" button, then press add files and select your
                    dataset files.
                  </li>
                </ol>
              </Grid>
              <Grid item xs={3.5}>
                ...
                >
                  ...
                  <Button
                    ...
                    variant="contained"
                    onClick={() => {
                      window.open(guiUploadingGuidanceLink, "_blank");
                    }}
                  >
                    Click to learn more
                  </Button>
            ...
            <h3>Large Dataset</h3>
            <div>
              If your dataset is large ({">"}5GB) or you would prefer to use the
              AWS CLI to upload your data, please follow the below steps.
            </div>
            <div>
              Please note that you need to have the AWS CLI v2 installed to
              follow the below steps. For more information on how to prepare
              your system for CLI upload (and download), visit{" "}
            ...
            <ol>
              <li>
                Shown below are your temporary <b>read-write</b> AWS
              ...
              <li>
                Copy and paste the credentials into your AWS CLI terminal
                environment. You can change the format of the environment
                variable export statements using the buttons above the generated
                credentials.
              </li>
              <li>
                Navigate to the system location containing the dataset folder
                using your terminal and run the aws s3 sync command. In the
                examples below, 'dataset' should be replaced with the dataset
                folder containing the files you want to upload. For example:
                <div className={classes.code}>
                  <CopyFloatingButton
                    clipboardText={`aws s3 sync dataset/ ${props.dataset.s3.s3_uri}`}
                  />
                  aws s3 sync dataset/ {props.dataset.s3.s3_uri}
                </div>
              </li>
              <li>
                You can verify your files were uploaded correctly by running the
                following command and verifying the contents are accurate:
                <div className={classes.code}>
                  <CopyFloatingButton
                    clipboardText={`aws s3 ls ${props.dataset.s3.s3_uri}`}
                  />
  ...
  // not authorised!
    ...
    return (
      <div>
        <h3>Unauthorised</h3>
        <p>
          You are not authorised to write to datasets in the registry. You need
          write access to upload dataset files. You can request additional roles
          at the{" "}
...
const MetadataSummary = observer((props: MetadataSummaryProps) => {
  ...
  const sharingLink =
    DOCUMENTATION_BASE_URL + "/data-store/viewing-a-dataset.html#collaborating";
  ...
  return (
    <div>
      <Stack direction="row" justifyContent="space-between" alignItems="center">
        ...
        <h3>Dataset Version {props.dataset.versioning_info?.version}</h3>
      </Stack>
      ...
      <Grid container>
        ...
        <Grid xs={12}>
          ...
          >
            You can use the handle link above to share your dataset with other
            users. For more information about sharing datasets, visit{" "}
    ...
    <React.Fragment>
      ...
      {props.workflowConfiguration.visible && (
        <WorkflowViewComponent
          startingSessionId={props.workflowConfiguration.startingSessionId}
          workflowDefinition={props.workflowConfiguration.workflowDefinition}
          defaultExpanded={props.workflowConfiguration.defaultExpanded}
...
const DatasetDetail = observer((props: DatasetDetailProps) => {
  ...
  const reposited =
    datasetDetailStore.datasetDetail?.collection_format.dataset_info.access_info
      .reposited ?? false;
        ...
        <DialogContent>
          <DialogContent>
            <p>
              ...
              access. <br />
              Error message:{" "}
              {accessState.errorMessage ?? "No error message provided."}
              <br />
              Try refreshing. If you are definitely authorised and still see
              this error, please use the <i>Contact Us</i> link to report an
              issue.
            </p>
          </DialogContent>
        </DialogContent>
    ...
    <Grid container>
      <Grid xs={12}>
        ...
        <p>
          ...
          <br></br>
          Try refreshing the page and ensure you have read permissions. If this
          error persists please contact us using the <i>Contact Us</i> link.
        </p>
      </Grid>
    </Grid>
  );
  ...
  const invalidObjectBodyContent = (
    <Grid container>
      <Grid xs={12}>
        <h3>An error occurred</h3>
        <p>
          It appears that the registry returned an invalid object. Please try
          refreshing and check your access permissions. If this error persists
          please contact us using the <i>Contact Us</i> link.
        </p>
      </Grid>
    </Grid>
  );
      ...
      <div>
        ...
        >
          <Stack direction="row" spacing={1}>
            ...
            {seeCloneButton && (
              <Button variant="outlined" href={`/clone-dataset/${handle_id}`}>
                Clone Dataset
              </Button>
            )}
            {
    ...
    return (
      <MetadataSummaryWorkflowComponent
        ...
        workflowConfiguration={{
          ...
          workflowDefinition: workflowConfiguration.workflowDefinition!,
    ...
    <Grid container>
      <Grid xs={12}>
        ...
        <p>
          ...
          {readCheck.fallbackGranted ? "this item" : "data"} in the data store
          registry.{" "}
          {!readCheck.fallbackGranted && (
            <p>
              You can manage your roles at the{" "}
              <a href={LANDING_PAGE_LINK_PROFILE}>Landing Portal.</a>
            </p>
          )}
        </p>
      </Grid>
  ...
  if (
    datasetLoading ||
    // Only be true during the first time loading,
