...
const overrideMissingLinkMessage = (
    <p>
        ...
        . If you believe you have already linked your user account to a Person
        in the registry, try refreshing this page.
    </p>
);
        ...
        return (
            <div className={classes.root}>
                <Grid container>
                    <Form
                        ...
                        onError={(errors) => {
                            console.log("Errors");
                            console.log(
                                JSON.stringify(newDatasetStore.currentValue)
                            );
                        }}
                        onSubmit={({ formData }) => {
                ...
                <Dialog open={newDatasetStore.error}>
                    ...
                    <DialogActions>
                        <Button
                            onClick={() => newDatasetStore.closeErrorDialog()}
                        >
                            Acknowledge
                        </Button>
                    </DialogActions>
