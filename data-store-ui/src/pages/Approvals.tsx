    ...
    const resArray: ApprovalRequestsListRow[] = !!loadedItem.dataset_items
        ? loadedItem.dataset_items.map((item: ItemDataset) => {
              ...
              const latestRequester =
                  ...
                  latestFirstHistory.find((release) => !!release.requester)
                      ?.requester;
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: (params: GridRenderCellParams) =>
                renderCellButton({
                    text: "Take Action",
                    link: datasetApprovalTakeActionLinkResolver(
                        params.row.dataset.id
                    ),
        ...
        },
        {
            ...
            renderCell: (params: GridRenderCellParams) =>
                renderCellButton({
                    text: "View Dataset",
                    link: datasetApprovalsTabLinkResolver(
                        params.row.dataset.id
                    ),
                    disabled: false,
                    buttonVariant: "contained",
    ...
    return (
        <Stack direction="column" className={classes.root} spacing={4}>
            ...
            <Typography variant="body1">
                ...
                reviewer. You can <strong>double click</strong> a row to view
                more details about the approval history of the dataset you
                clicked on. You can click 'Take Action' to respond to the
                request.
            </Typography>
