            ...
            <Stack direction="column" className={classes.fullWidth} spacing={4}>
                ...
                {errorOccurredFindingRequester ? (
                    <Stack direction="column" className={classes.fullWidth}>
                        <Alert variant="outlined" severity="error">
                            <AlertTitle>
                                Error: An error occurred when fetching
                                requester's information.
                            </AlertTitle>
                            Requester information cannot be found in the
                            dataset's release history.
                        </Alert>
                    </Stack>
                ) : (
                    <GenericDetailViewWrapperComponent
            ...
            <form onSubmit={handleSubmit}>
                <Stack direction="column" spacing={4}>
                    ...
                    <Typography variant="h5">
                        Please review and take action on the current approval
                        request:
                    </Typography>
                    {/* Approver notes */}
                    <Stack>
                ...
                >
                    ...
                    >
                        <Alert variant="outlined" severity="success">
                            <AlertTitle>
                                Success: Your approval action has been submitted
                                successfully.
                            </AlertTitle>
                            You will be redirected to the dataset's approvals
