...
const overrideMissingLinkMessage = (
  <p>
    ...
    account to a registered Person in the Registry. For more information, visit{" "}
    <a
...
export const ApprovalsTabView = (props: ApprovalsTabViewProps) => {
  ...
  const hideJHistoryButton =
    !props.dataset.release_history || props.dataset.release_history.length <= 0;
      ...
      <Stack direction="column" className={classes.root} spacing={4}>
        ...
        >
          <Stack direction="column" spacing={4}>
            {/* Approval status row */}{" "}
            <Stack>
              <Grid container className={classes.approvalStatusRow}>
                <Grid item xs={2}>
                ...
                <Grid item xs={8} className={classes.actionButtons}>
                  {/* Action buttons */}
                  <Stack direction="row" spacing={1} justifyContent="flex-end">
                      ...
                      >
                        <Box>
                          <Button
                            variant="contained"
                            disabled={
                              takeActionForApprovalDisabled || userLinkError
                            }
                      ...
                      >
                        <Box>
                          <Button
                            variant="contained"
                            disabled={
                              submitForApprovalDisabled || userLinkError
                            }
                    ...
                    {!hideJHistoryButton && (
                      <Button
                        ...
                        onClick={handleApprovalsHistoryOnClick}
                      >
                        Approvals History
                      </Button>
                    )}
                    ...
                    {approvalsHistoryDialogOpen && (
                      <ApprovalsHistoryDialog
                        dialogOpen={approvalsHistoryDialogOpen}
                        setDialogOpen={setApprovalsHistoryDialogOpen}
            ...
            {props.dataset.release_status === ("PENDING" as ReleasedStatus) &&
              !!datasetApproverId && (
                ...
                >
                  <CardContent>
                    <Stack direction="column" className={classes.tbPaddings}>
                    ...
                    <Stack className={classes.tbPaddings}>
                      <Typography variant="body1">
                        <GenericDetailViewWrapperComponent
                          item={{
                            linked_person_id: datasetApproverId,
                          }}
                          layout={"column"}
                        />
                      </Typography>
          ...
          {!!requester &&
            ...
            approvalState !== "NOT_RELEASED" && (
              <Stack direction="column" spacing={4}>
                ...
                <Stack direction="column" spacing={4}>
                  <Typography variant="h6">Requester Note: </Typography>
                  <Typography variant="body1">
                    <RenderLongTextExpand
                      text={requesterNote}
                      initialCharNum={500}
            ...
            props.dataset.release_status !== ("PENDING" as ReleasedStatus) && (
              <Stack direction="column" spacing={4}>
                <Stack direction="column" spacing={4}>
                  ...
                  <GenericDetailViewWrapperComponent
                    item={{
                      created_timestamp: approvalActionTime,
                    }}
                    layout={"column"}
                  />
                  <GenericDetailViewWrapperComponent
                ...
                <Stack direction="column" spacing={4}>
                  <Typography variant="h6">Approver Note: </Typography>
                  <Typography variant="body1">
                    <RenderLongTextExpand
                      text={approverNote}
                      initialCharNum={500}
