...
import { Credentials } from "react-libs/provena-interfaces/DataStoreAPI";
          ...
          items={[
            {
              label: "Copy S3 URI",
              action: () => {
                copyToClipboard(`s3://${props.bucketName}/${item.path}`);
                props.displayPopup(
          ...
          <ThreeDotMenu
            items={[
              ...
              },
              {
                label: (
                  <>
                    Download <DownloadIcon style={{ marginLeft: "20px" }} />
                  </>
                ),
                action: () => {
                  props.getPresignedUrl(
                    ...
                    (url) => {
                      ...
                      props.displayPopup("Starting download...", "success");
