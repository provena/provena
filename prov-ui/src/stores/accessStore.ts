      ...
      .then(
        action((response) => {
          ...
          if (res.status.success) {
            ...
            const registryComponentName: ComponentName = "entity-registry";
            ...
            for (const component of res.report.components) {
              if (component.component_name == registryComponentName) {
                ...
                for (const accessRole of component.component_roles) {
                  ...
                  if (accessRole.role_level === readLevel) {
                    ...
                    this.registryReadAccess = accessRole.access_granted;
                  }
                  if (accessRole.role_level === writeLevel) {
                    registryWriteFound = true;
                    this.registryWriteAccess = accessRole.access_granted;
                  }
                }
              }
            }
