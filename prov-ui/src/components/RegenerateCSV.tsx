...
const RegenerateCSV = observer((props: RegenerateCSVProps) => {
    ...
    */
    ...
    const isDownloadedContent = (
        ...
        >
            <Grid item xs={12}>
                Your CSV template with updated job status entries has been
                downloaded.
            </Grid>
            <Grid item>
                <Button
    ...
    const requiresDownloadContent = (
        ...
        >
            <Grid item>
                Click here to download an updated CSV template which includes an
                update to the job status headers:
            </Grid>
            <Grid item>
                <Button
                    variant="outlined"
    ...
    return (
        <Grid item xs={12}>
            {isFetching ? (
                ...
                <React.Fragment>
                    An error occurred while requesting an updated CSV template,
                    error message: {error}.
                </React.Fragment>
