                ...
                <DialogContent>
                    <DialogContent>
                        <p>
                            ...
                            <br />
                            Press <i>Dismiss</i> to attempt interacting with the
                            prov store anyway. If you are definitely authorised
            ...
            <div className={classes.root}>
                ...
                >
                    <Alert severity="warning">
                        You do not have write permission to the provenance
                        store.
                    </Alert>
                    <Button
                        variant="outlined"
    ...
    if (!(accessStore.registryReadAccess || accessStore.forceErrorBypass)) {
        return (
            <div className={classes.root}>
                ...
                >
                    <Alert severity="warning">
                        You do not have sufficient permission to read from the
                        entity registry!
                    </Alert>
                    <Button
                        variant="outlined"
