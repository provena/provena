  ...
  return (
    <Grid container>
      <Grid container item className={classes.topPanelContainer}>
        <Grid id="title-text" container item className={classes.topPanel}>
        ...
        <Grid container item xs={12} className={classes.recordInfoPanel}>
          <Grid container item xs={12} className={classes.bodyPanelContainer}>
            ...
            {fetchErrorOccurred && (
              <>
                <Alert className={classes.alert} severity="error">
                  An error occurred while fetching the root entity, error:{" "}
                  {errorMessage ??
                    "Unknown - check console and contact us for help."}
                </Alert>
              </>
            ...
            >
              <Stack
                ...
                style={{ width: "100%" }}
              >
                <Typography variant="h6">Root Record Details</Typography>
                <div
                  className={classes.rootRecordDetailsContainer}
                  style={{ height: "100%" }}
                >
              ...
              <Grid container item xs={12}>
                ...
                >
                  <Typography variant="body1">
                    Loading entity details and determining access...
                  </Typography>
                </Grid>
              </Grid>
            )}
