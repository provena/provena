...
try:
    from SharedInterfaces.SharedTypes import Status, StatusResponse, ImportMode
    from SharedInterfaces.RegistryModels import Roles
except:
...
# for a given group
try:
    # from SharedInterfaces.DataStoreAPI import GroupActionsConfiguration
    None
except:
    None
