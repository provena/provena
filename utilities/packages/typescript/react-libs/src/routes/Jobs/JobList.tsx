            ...
            <Grid container justifyContent={"space-between"}>
                <Grid item xs={isJobAdminWrite ? 5 : 12}>
                    ...
                    <Typography variant="subtitle1">
                        Jobs are created during interaction with the system. You
                        can view the details of a standalone or batch job, by
                        clicking on the entry below. Click the 'Load More'
                        button to fetch more items.
                    </Typography>
                </Grid>
                {isJobAdminWrite && (
                    <Grid item xs={5}>
