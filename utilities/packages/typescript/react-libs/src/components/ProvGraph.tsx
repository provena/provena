...
const ProvGraph = observer((props: ProvGraphProps) => {
  ...
  const { render, height } = useProvGraphRenderer({
    controls: {
      ...
      selectFocusNode: graphHook.controls?.selectFocusNode ?? ((id) => {}),
      deselectFocusNode: graphHook.controls?.deselectFocusNode ?? voidHandler,
      setUpstreamExpansion:
        graphHook.controls?.setUpstreamExpansion ?? ((expandUpstream) => {}),
        ...
        <Stack direction="column" alignItems="center">
          {graphHook.status.error && (
            <Alert variant="outlined" color="error" severity="error">
              ...
              <br /> <br />
              Error: {graphHook.status.errorMessage ?? "Unknown"}. <br />
              <br />
          ...
          {showGraphEmpty && (
            <Alert variant="outlined" color="info" severity="info">
              ...
              <br /> <br />
              There are no connections to or from this root node. No graph will
              be rendered.
            </Alert>
          )}
          <Grid container>
              ...
              <Grid item xs={detailWidth}>
                ...
                >
                  <SideDetailPanel
                    ...
                    onExploreRoot={() => {
                      props.setRootId(graphHook.focusNodeId!);
                    }}
                    disableExplore={graphHook.focusNodeId === props.rootId}
