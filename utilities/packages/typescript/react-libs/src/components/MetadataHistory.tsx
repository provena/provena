            ...
            >
                ...
                <Grid item>
                    <MetadataHistoryStatusDisplay
                        ...
                        onRequestCheckout={() => {
                            if (
                                props.versionControls.controls
                        ...
                        onRequestRevert={() => {
                            if (
                                props.revertControls.startRevert !== undefined
                            ) {
                        ...
                        onRequestReturnToLatest={() => {
                            if (
                                ...
                                if (props.latestId !== undefined) {
                                    props.versionControls.controls.manuallySetId(
                                        props.latestId
                                    );
                                }
                            }
                ...
                <Grid item xs={12}>
                    Click the icon above to inspect the history of this item's
                    metadata.
                </Grid>
            </Grid>
        </React.Fragment>
