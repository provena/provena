/**
  Modified version of base ArrayField which doesn't allow any addition, movement or deletion of items. 
  
  See https://github.com/rjsf-team/react-jsonschema-form/blob/main/packages/core/src/components/fields/ArrayField.tsx
*/
