...
import { JobStatus, JobStatusTable } from "../provena-interfaces/AsyncJobAPI";
            ...
            <React.Fragment>
              <Stack direction="row" spacing={2}>
                ...
                <Button
                  variant="outlined"
                  onClick={() => {
                    props.setOutputExpanded(!props.outputExpanded);
                  }}
                >
                  {props.outputExpanded ? "Collapse" : "Expand"}
                </Button>
              </Stack>
      ...
      return (
        <div>
          ...
          <Typography variant="body1">
            Try waiting a few seconds. If the job does not load, please contact
            us. Information: {monitor.errorMessage ?? "No info provided."}
          </Typography>
        </div>
      );
    };
