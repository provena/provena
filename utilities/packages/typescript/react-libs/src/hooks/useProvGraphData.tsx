...
import { LineageResponse } from "../provena-interfaces/ProvenanceAPI";
...
export const useProvGraphData = (
  ...
  const [downstreamExpansion, setDownstreamExpansion] = useState<boolean>(true);
  ...
  const errorMessage: string | undefined = expandQueries.find((q) => q.isError)
    ?.error as string;
