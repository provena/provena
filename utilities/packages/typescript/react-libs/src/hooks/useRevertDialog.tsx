...
> = new Map([
  ...
  [
    ...
    (id: string, version?: number) => {
      ...
      return (
        <p>
          You cannot revert to a previous metadata history of a dataset from the
          registry. Instead, visit the item in the{" "}
    ...
    (id: string) => {
      return (
        <p>
          ...
          you would like to discuss options to help manage changes to existing
          model runs, please contact us.
        </p>
      );
    },
  ],
  ...
  if ((props.context ?? ("registry" as Context)) === "registry") {
    ...
    if (props.subtype && props.id && props.subtype !== "DATASET") {
      nonRevertableContent = (
        <p>
          You cannot revert to a previous metadata history of a non dataset from
          the data store. Instead, visit the item in the{" "}
          ...
          <DialogContent>
            {nonRevertableContent !== undefined ? (
              ...
              <Stack spacing={2} direction="column">
                <DialogContentText>
                  Please provide a reason to revert to this previous metadata
                  version.
                </DialogContentText>
                <TextField
                  value={reason}
                ...
                {error && (
                  <Alert severity="error" variant="outlined">
                    ...
                    <Typography variant="subtitle1">
                      An error occurred while running the revert operation.
                      Error:{" "}
                      {errorMessage
