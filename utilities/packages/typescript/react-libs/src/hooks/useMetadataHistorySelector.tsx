...
export interface UseMetadataHistorySelectorProps {
  // The item to analyse for historical options
  item?: ItemBase;
}
export interface UseMetadataHistorySelectorOutput {
  state?: {
    historyId?: number;
  };
  controls?: {
...
export const useMetadataHistorySelector = (
  props: UseMetadataHistorySelectorProps,
): UseMetadataHistorySelectorOutput => {
  /**
    Hook: useMetadataHistorySelector
      ...
      return (
        ...
        >
          ...
          <DialogContent>
            <Stack spacing={2}>
              <DialogContentText>
                If you would like to review the history of this item's metadata,
                you can select a previous iteration from the list below.
              </DialogContentText>
              ...
              onClick={() => {
                if (tempSelectionState !== undefined) {
                  if (setHistoryId !== undefined) {
                    setHistoryId(tempSelectionState.toString());
                  } else {
                    console.error(
