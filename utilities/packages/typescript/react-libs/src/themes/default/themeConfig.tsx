...
export const defaultThemeConfig: CompleteThemeConfig = {
  ...
  hamburgerNavigation: {
    docsLink: DOCUMENTATION_BASE_URL,
    docsName: "Provena Docs",
  },
  footerConfig: {
  ...
  landingPortal: {
    ...
    introductionBodyHtml: (
      <React.Fragment>
        To use Provena, begin by logging in and requesting access roles. Once
        you are logged in, you will need to request access to the system
        components you want to use. Information on this process is available.
        For more information on how to login and requesting access roles, visit
        our documentation.
      </React.Fragment>
    ),
    ...
    rhCardBodyHtml: (
      <React.Fragment>
        <p>
          As an open-source system, Provena values transparency and community
          support. Discover a wealth of information and assistance in our
          support resources, accessible via the Provena Resources.
        </p>
      </React.Fragment>
    ),
    rhCardActionsHtml: (
