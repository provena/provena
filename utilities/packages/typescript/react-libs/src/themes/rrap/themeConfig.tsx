...
export const rrapThemeConfig: CompleteThemeConfig = {
  ...
  hamburgerNavigation: { docsLink: KNOWLEDGE_HUB, docsName: "Knowledge Hub" },
  footerConfig: {
    ...
    footerRhBodyHtml: (
      <React.Fragment>
        ...
        <a href="https://gbrrestoration.org/privacy-policy/">Privacy Policy</a>
      </React.Fragment>
    ),
  },
  landingPortal: {
    ...
    introductionBodyHtml: (
      <React.Fragment>
        To use the RRAP M&DS IS, begin by logging in and requesting access
        roles. Once you are logged in, you will need to request access to the
        system components you want to use. Information on this process is
        available. For more information on how to login and requesting access
        roles, visit our documentation.
      </React.Fragment>
    ),
    lhCardTitle: "About the RRAP M&DS",
    lhCardBodyHtml: (
      <React.Fragment>
        The Reef Restoration and Adaptation Program (RRAP) is a collaboration of
        Australia's leading experts to create a suite of innovative and targeted
        measures to help preserve and restore the Great Barrier Reef. These
        interventions must have strong potential for positive impact, be
        socially and culturally acceptable, ecologically-sound, ethical and
        financially responsible. They would be implemented if, when and where it
        is decided action is needed - and only after rigorous assessment and
        testing. Learn more about the Reef Restoration and Adaptation Program{" "}
    ...
    rhCardBodyHtml: (
      <React.Fragment>
        ...
        <ul>
          ...
          <li>
            Information flows between modelling and decision support teams,
          </li>
          <li>
            Provision of information to support management decisions in RRAP
          </li>
        </ul>
