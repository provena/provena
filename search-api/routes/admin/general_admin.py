...
from dependencies.dependencies import sys_admin_read_write_user_protected_role_dependency
router = APIRouter()
...
async def trigger_error(
    user: User = Depends(sys_admin_read_write_user_protected_role_dependency)
