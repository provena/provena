from dependencies.dependencies import sys_admin_read_user_protected_role_dependency, sys_admin_read_write_user_protected_role_dependency, user_general_dependency, sys_admin_admin_user_protected_role_dependency
...
async def check_admin_access(
    protected_role: ProtectedRole = Depends(
        sys_admin_admin_user_protected_role_dependency)
) -> User:
    """
    Function Description
    --------------------
...
async def check_read_access(
    protected_roles: ProtectedRole = Depends(
        sys_admin_read_user_protected_role_dependency)
) -> User:
    """
    Function Description
    --------------------
