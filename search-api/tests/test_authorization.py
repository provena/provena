...
def test_check_write_protected_access() -> None:
    ...
    # Override the auth dependency
    app.dependency_overrides[sys_admin_read_write_user_protected_role_dependency] = user_protected_dependency_override
...
def test_check_admin_protected_access() -> None:
    ...
    # Override the auth dependency
    app.dependency_overrides[sys_admin_admin_user_protected_role_dependency] = user_protected_dependency_override
...
def test_check_read_protected_access() -> None:
    # Checks protected role access once overridden
    # Override the auth dependency
    app.dependency_overrides[sys_admin_read_user_protected_role_dependency] = user_protected_dependency_override
