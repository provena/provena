...
import pytest
from tests.config import test_bucket_name, test_registry_name, test_email
...
write_role_secured_endpoints = [
    ("/register/mint-dataset", "POST"),
    ("/check-access/check-write-access", "GET"),
    ("register/update-metadata", "POST")
]

read_role_secured_endpoints = [
    ("/metadata/dataset-schema", "GET"),
    ("/check-access/check-read-access", "GET"),
    ("/registry/items/list", "POST"),
    ("/registry/items/fetch-dataset", "GET"),
]
